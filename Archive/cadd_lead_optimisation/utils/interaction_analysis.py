...
class InteractionAnalysis:
    ...
    def __init__(
        ...
        self.interaction_analysis_output_path = interaction_analysis_output_path
    ...
    def plot_interaction_affinity_correlation(self):
        ...
        # Save the figure
        plt.savefig(self.interaction_analysis_output_path / 'interaction_affinity_correlation.png', dpi=300)
