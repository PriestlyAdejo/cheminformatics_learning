...
def split_multistructure_file(filetype, filepath, output_folder_path=None):
    ...
    for i, structure in enumerate(structures, 1):
        output_filepath = output_folder_path / "poses" / f"pose_{i}" 
        helper_io.create_folder(output_filepath)
        output_filepath = output_filepath / f"{filename}_{i}.{filetype}"
